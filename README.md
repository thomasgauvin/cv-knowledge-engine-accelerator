...
In the Storage Account, create a new Blob container (ie: "lookuptables"). Upload the two files in [Assets/Lookup Tables](https://github.com/AhmedAlmu/cv-knowledge-engine-accelerator/tree/main/Assets/Lookup%20Tables) to this container, and get their SAS URL to be used in the skill definition. After both URLs are provided, add them to your Postman variables for <LOOKUP_TABLE_URL_ONE> and <LOOKUP_TABLE_URL_TWO>.  
